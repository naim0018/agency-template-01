  ...
  return (
    <footer className="bg-[#1C1E53] text-white">
      <div className="pt-12 md:pt-20">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row px-6 gap-12 lg:gap-0">
          {/* Left Column */}
          ...
          <div className="">
            ...
            {/* Contact Info Box */}
            <div className="bg-[#FCD980] p-6 md:p-8 text-[#282938]">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8">
                <div>
                  <p className="font-medium mb-1">Email me at</p>
                  <a 
                    href="mailto:contact@website.com" 
                    className="text-sm hover:text-[#2405F2] transition"
                  >
                    contact@website.com
                  </a>
                </div>
          ...
          <div className="w-full lg:w-2/3 lg:pl-32">
            ...
            <div className="flex items-center gap-6">
              <a href="#" className="hover:text-[#FCD980] transition">
        ...
        <div className="bg-white">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center px-6 py-6 md:py-8 gap-4">
            ...
            <div className="flex flex-wrap justify-center md:justify-end gap-4 md:gap-8">
              ...
              <a href="#" className="text-black hover:text-[#FCD980] transition">About us</a>
              <a href="#" className="text-black hover:text-[#FCD980] transition">Features</a>
              <a href="#" className="text-black hover:text-[#FCD980] transition">Pricing</a>
              <a href="#" className="text-black hover:text-[#FCD980] transition">FAQ</a>
              <a href="#" className="text-black hover:text-[#FCD980] transition">Blog</a>
            </div>
          </div>
        </div>
      </div>
